...
import { Megaphone, Stethoscope, CheckCircle2, Circle, Plus } from 'lucide-react';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className='m-4 flex justify-between items-center'>
                <h2 className="text-xl font-semibold flex items-center gap-2">
                    <Stethoscope className="w-5 h-5" /> Historial Médico
                </h2>
                <Link href="/registros/create">
                    <Button className='bg-green-600 hover:bg-green-700 font-semibold '>Nuevo Registro</Button>
                </Link>
            </div>
