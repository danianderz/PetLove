...
import mascotas, { store, update } from '@/routes/mascotas';
...
export default function Edit({ mascota }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Editar Mascota', href: '/mascotas/' + mascota.id + '/edit' }]}>
            <Head title="Editar Mascotas" />
            <div className='w-8/12 p-4'>
                <form onSubmit={handleUpdate} className="space-y-4">
                    ...
                    <Button disabled={processing} type="submit">Editar Mascota</Button>
                </form>
            </div>
        </AppLayout>
    );
