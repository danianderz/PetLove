...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducciones para los mensajes de validación.
    |
    */
    ...
    | convención "attribute.rule" para nombrar las líneas.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para intercambiar nuestro placeholder de atributo
